...
export async function getBacProfile(): Promise<User | null> {
  try {
    const {
      data: { user },
    ...
    console.error("Error fetching BAC profile:", error)
    throw new Error("Failed to fetch BAC profile")
  }
}
