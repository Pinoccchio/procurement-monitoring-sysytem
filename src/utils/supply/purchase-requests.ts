...
export async function getSupplyProfile(): Promise<User | null> {
  try {
    const {
      data: { user },
    ...
    console.error("Error fetching supply profile:", error)
    throw new Error("Failed to fetch supply profile")
  }
}
