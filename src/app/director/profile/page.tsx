  ...
  useEffect(() => {
    async function loadDirectorProfile() {
      try {
        ...
        console.error("Error loading director profile:", error)
        setError("Failed to load director profile. Please try again later.")
      } finally {
        setIsLoading(false)
      }
    }
    ...
    return (
      <div className="flex justify-center items-center h-screen">
        <div className="text-gray-500 text-center">
          ...
          <p>Unable to retrieve director profile information.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-center text-[#2E8B57]">Director User Profile</CardTitle>
          </CardHeader>
