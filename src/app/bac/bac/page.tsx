  ...
  async function loadPurchaseRequests() {
    try {
      ...
      setPurchaseRequests(
        data.filter(
          (pr) =>
            ["forwarded", "approved", "received", "disapproved", "returned", "pending"].includes(pr.status) &&
            pr.current_designation === "bac",
        ),
      )
    } catch (error) {
              ...
              {filteredRequests.map((pr) => (
                <Card
                  ...
                  className={cn(
                    ...
                    pr.status === "pending" && "border-l-4 border-l-gray-500",
                  )}
                >
                          ...
                          <p>
                            ...
                            <span
                              className={cn(
                                ...
                                pr.status === "pending" && "text-gray-500",
                              )}
                            >
                              {pr.status}
                            </span>
