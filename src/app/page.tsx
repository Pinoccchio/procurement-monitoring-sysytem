              ...
              {[
                {
                  ...
                  description:
                    "Get instant insights into your procurement processes with our advanced analytics dashboard.",
                },
                {
                  icon: Clock,
                  title: "Efficient Workflows",
                  description:
                    "Streamline approvals and reduce bottlenecks with our intuitive workflow management system.",
                },
                {
                  icon: Users,
                  title: "Multi-role Support",
                  description:
                    "Tailor access and permissions for various roles including end-users, admins, and directors.",
                },
                {
                  icon: FileText,
                ...
                },
                {
                  ...
                  description:
                    "Ensure adherence to regulations and internal policies with built-in compliance features.",
                },
                {
                  icon: Search,
                  title: "Advanced Search",
                  description:
                    "Quickly find the information you need with our powerful search and filtering capabilities.",
                },
              ].map((feature, index) => (
                <motion.div
                  key={feature.title}
