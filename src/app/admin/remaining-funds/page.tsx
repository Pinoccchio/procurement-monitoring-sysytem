...
export default function AdminRemainingFundsPage() {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      try {
        const [profile, funds] = await Promise.all([getAdminProfile(), getRemainingFunds()])
        setUser(profile)
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-2xl font-bold mb-6 text-[#2E8B57]">Admin Remaining Funds View</h1>
