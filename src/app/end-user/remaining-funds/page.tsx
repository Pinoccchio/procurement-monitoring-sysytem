...
export default function EndUserRemainingFundsPage() {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      try {
        const [profile, funds] = await Promise.all([getEndUserProfile(), getRemainingFunds()])
        setUser(profile)
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-2xl font-bold mb-6 text-[#2E8B57]">End User Remaining Funds View</h1>
