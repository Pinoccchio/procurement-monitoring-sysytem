...
import { getTrackingHistory, supabaseClient } from "@/utils/admin/purchase-requests"
import type { TrackingEntry } from "@/types/admin/purchase-request"
...
export function AdminAppBar({ isSidebarOpen, onSidebarOpenChange, className }: AdminAppBarProps) {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-[#2E8B57] hidden sm:block">Admin Management</h1>
          </div>
